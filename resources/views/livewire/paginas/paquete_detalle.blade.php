            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden position-relative" style="background: rgba(255, 255, 255, 0.97);">
                ...
                <div class="row g-0 position-relative" style="z-index:2;">
                    <div class="col-md-5 d-flex align-items-stretch">
                        <img src="{{ asset('images/' . $paquete->imagen) }}" alt="{{ $paquete->nombre }}" 
                        ...
                        <div class="card-body p-5 text-light">
                            ...
                            <ul class="list-group list-group-flush mb-4">
                                <li class="list-group-item bg-transparent text-light border-0">
                                    ...
                                    <span class="text-info">{{ $paquete->duracion }}</span>
                                </li>
                                <li class="list-group-item bg-transparent text-light border-0">
                                    <strong>Precio:</strong> 
                                    <span class="text-success fw-bold">S/ {{ number_format($paquete->precio, 2) }}</span>
                                </li>
                            </ul>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ url('/paquetes') }}" class="btn btn-link text-info">Volver a paquetes</a>
                            </div>
                        </div>
                    </div>
                </div>
